...
Version  : 0.8.3
Release  : 9
URL      : https://github.com/openSUSE/multipath-tools/archive/0.8.3.tar.gz
Source0  : https://github.com/openSUSE/multipath-tools/archive/0.8.3.tar.gz
...
%prep
%setup -q -n multipath-tools-0.8.3
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1571277592
...
cp COPYING %{buildroot}/usr/share/package-licenses/multipath-tools/COPYING
%make_install
...
/usr/share/package-licenses/multipath-tools/COPYING
