...
Version  : 0.8.7
Release  : 13
URL      : https://github.com/opensvc/multipath-tools/archive/0.8.7/multipath-tools-0.8.7.tar.gz
Source0  : https://github.com/opensvc/multipath-tools/archive/0.8.7/multipath-tools-0.8.7.tar.gz
...
%prep
%setup -q -n multipath-tools-0.8.7
cd %{_builddir}/multipath-tools-0.8.7
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631118897
...
cp %{_builddir}/multipath-tools-0.8.7/COPYING %{buildroot}/usr/share/package-licenses/multipath-tools/ba8966e2473a9969bdcab3dc82274c817cfd98a1
%make_install
