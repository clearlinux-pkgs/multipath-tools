...
Version  : 0.9.2
Release  : 17
URL      : https://github.com/opensvc/multipath-tools/archive/0.9.2/multipath-tools-0.9.2.tar.gz
Source0  : https://github.com/opensvc/multipath-tools/archive/0.9.2/multipath-tools-0.9.2.tar.gz
...
%prep
%setup -q -n multipath-tools-0.9.2
cd %{_builddir}/multipath-tools-0.9.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666741643
...
make  %{?_smp_mflags}  prefix=/usr includedir=/usr/include man8dir=/usr/share/man/man8 man5dir=/usr/share/man/man5 man3dir=/usr/share/man/man3 SYSTEMDPATH=lib
...
%make_install prefix=/usr includedir=/usr/include man8dir=/usr/share/man/man8 man5dir=/usr/share/man/man5 man3dir=/usr/share/man/man3 SYSTEMDPATH=lib
