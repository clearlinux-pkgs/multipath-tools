...
Source0  : https://github.com/opensvc/multipath-tools/archive/0.9.1/multipath-tools-0.9.1.tar.gz
...
%prep
%setup -q -n multipath-tools-0.9.1
cd %{_builddir}/multipath-tools-0.9.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662757415
