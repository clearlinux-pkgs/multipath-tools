...
Version  : 0.9.5
Release  : 20
URL      : https://github.com/opensvc/multipath-tools/archive/0.9.5/multipath-tools-0.9.5.tar.gz
Source0  : https://github.com/opensvc/multipath-tools/archive/0.9.5/multipath-tools-0.9.5.tar.gz
...
%prep
%setup -q -n multipath-tools-0.9.5
cd %{_builddir}/multipath-tools-0.9.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680887493
