...
Version  : 0.9.3
Release  : 18
URL      : https://github.com/opensvc/multipath-tools/archive/0.9.3/multipath-tools-0.9.3.tar.gz
Source0  : https://github.com/opensvc/multipath-tools/archive/0.9.3/multipath-tools-0.9.3.tar.gz
...
%prep
%setup -q -n multipath-tools-0.9.3
cd %{_builddir}/multipath-tools-0.9.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666896653
