...
Version  : 0.9.4
Release  : 19
URL      : https://github.com/opensvc/multipath-tools/archive/0.9.4/multipath-tools-0.9.4.tar.gz
Source0  : https://github.com/opensvc/multipath-tools/archive/0.9.4/multipath-tools-0.9.4.tar.gz
...
%prep
%setup -q -n multipath-tools-0.9.4
cd %{_builddir}/multipath-tools-0.9.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672187953
